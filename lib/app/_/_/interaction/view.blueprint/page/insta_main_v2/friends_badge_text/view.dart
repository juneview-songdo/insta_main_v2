...
class FriendsBadgeTextView extends StatefulWidget {
  FriendsBadgeTextView(
      {super.key,
      required this.num,
      required this.size,
  ...
  @override
  State<FriendsBadgeTextView> createState() => StateChild();
}

class FriendsBadgeTextViewState extends State<FriendsBadgeTextView> with StateMother {
  @override
